...
const DespachoUsoVehiculo = ({ despacho }) => {
        ...
        <View style={styles.section}>
          ...
          <View style={styles.table}>
            <View style={styles.tableRow}>
              ...
              <Text style={styles.tableColHeader}>Uso Vehic.</Text>
            </View>
            {despacho.map((item, index) => (
              <View key={index} style={styles.tableRow}>
                ...
                <Text style={styles.tableCol}>{item.name_uso}</Text>
              </View>
            ))}
          </View>
        </View>
...
export default DespachoUsoVehiculo;
