...
const EliminarUsoVehiculo = ({ id_uso }) => {
      ...
      try {
        ...
        if (result.isConfirmed) {
          ...
          const resp = await axios.delete(
            `${process.env.NEXT_PUBLIC_NEXTAUTH_URL}/api/cars/usocars/${id_uso}`
          );
          ...
          if (resp.status === 200) {
            ...
            router.push(
              `${process.env.NEXT_PUBLIC_NEXTAUTH_URL}/auth/dashboard/usovehiculo`
            );
            router.refresh();
          }
        }
...
export default EliminarUsoVehiculo;
